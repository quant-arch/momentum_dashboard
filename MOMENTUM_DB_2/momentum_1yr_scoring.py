...
def run_momentum_strategy(universe_file: str,
    ...
    while True:
        current_end = current_start + relativedelta(months=12)
    ...
    for start, end, prices in windows:
        ...
        if prices.empty:
            print(" All price data missing. Skipping window.")
            continue
    ...
    if not master_data:
        print(" No window files found, master not created.")
        return None
...
master_file = run_momentum_strategy(
    ...
    output_dir_override=r"C:\Users\anike\Desktop\Ocean_dev\Momentum Handover\Momentum Handover\MOMENTUM_DB_2\Stocks_old\Nifty_500_2025_Apr_1yr_20_stocks_results"
)
