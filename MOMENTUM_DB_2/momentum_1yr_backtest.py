...
def main():
    ...
    # ----------------------------------------------------------------
    INPUT_FILE    = r"C:\Users\anike\Desktop\Ocean_dev\Momentum Handover\Momentum Handover\MOMENTUM_DB_2\Stocks_old\Nifty_500_2025_Apr_1yr_20_stocks_results\master_momentum_summary.xlsx"
    ...
    VEDL_OUTPUT   = os.path.join(OUTPUT_FOLDER,
                                  "Nifty_500_2025_Apr_1yr_20_stocks_results_GoldSilverDebt_buy&hold_returns.xlsx")
